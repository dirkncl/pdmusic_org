...
/**********************additional*************************************/
function tip(){var c=document.body.appendChild(document.createElement("div"));c.id="tip";c.style="position:fixed;top:0;right:0;height:600px;visibility:hidden;z-index:200";var d=document.getElementById("tip").style;d.visibility="visible";d.display="none";d.overflowY="auto";if(null!=arguments.length){if(2===arguments.length){var b=!0;var a=arguments[0];var e=arguments[1]}1===arguments.length&&(""===arguments[0]?b=!1:(b=!0,a=arguments[0],e="white"));!0===b?getText(a,function(a){var b=e;document.head.appendChild(document.createElement("style")).textContent=
"#tip::-webkit-scrollbar {width: 5px;height: 0px;}#tip::-webkit-scrollbar-track {-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border-radius: 10px;}#tip::-webkit-scrollbar-thumb {border-radius: 3px;-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.5);}";a='<center><button style="position:fixed;background-color:gold;z-index:201" onclick="tip()">close</button></center><div style="padding:12px;opacity:0.9;background-color:'+b+'"><br><br><font color="black" size=2>'+a+"</font></div>";document.getElementById("tip").innerHTML=
a;d.display=""}):(d.visibility="hidden",d.display="none")}}function getText(c,d){var b="",a=new XMLHttpRequest;a.overrideMimeType("text/plain; charset=iso-8859-1");a.onload=function(){for(var e=a.responseText.split("\n"),c=0;c<e.length;c++)b=b+e[c]+"<br>";d(b)};a.open("GET",c,!0);a.send()};window.onload=function(){var b=document.createElement("iframe");b.name="iframe";b.frameborder="0";b.setAttribute("frameBorder","0");b.style="position:fixed;bottom:0;left:0;max-width:40%;max-height:35px;display:;opacity:0.9";document.body.appendChild(b);b=document.getElementsByTagName("a");for(var c=[],d=[],e=[],a=0;a<b.length;a++)d[a]=b[a].href,c[a]=d[a].split(".").pop().toLowerCase(),"mid"===c[a]||"kar"===c[a]||"midi"===c[a]||"rmi"===c[a]?(e[a]=d[a],b[a].target="iframe",b[a].href="../curiousMidi/index.html?"+
e[a]):"htm"===c[a]||"html"===c[a]?(e[a]=d[a],b[a].target="_top",b[a].href=e[a]):b[a].target="_blank"};